...
export const uxIntentMap = Object.freeze({
    ...
    [EventTypes.NODE_REPARENT]: UXIntent.HARD_UNSAFE,
    [EventTypes.NODE_REORDER]: UXIntent.HARD_UNSAFE,
    [EventTypes.NODE_WRAP]: UXIntent.HARD_UNSAFE,
    [EventTypes.NODE_UNWRAP]: UXIntent.HARD_UNSAFE,
    ...
    [EventTypes.LAYOUT_CONVERT]: UXIntent.HARD_UNSAFE,

    [EventTypes.TIMELINE_TRACK_CREATE]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_TRACK_DELETE]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_TRACK_REORDER]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_TRACK_CHANNEL_ASSIGN]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_TRACK_LOCK_TOGGLE]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_TRACK_BLEND_MODE_SET]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_GROUP_CREATE]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_GROUP_DELETE]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_GROUP_LOCK_TOGGLE]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_GROUP_COLLAPSE_TOGGLE]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_GROUP_TRACK_ASSIGN]: UXIntent.HARD_UNSAFE,
    [EventTypes.TIMELINE_GROUP_TRACK_UNASSIGN]: UXIntent.HARD_UNSAFE,
