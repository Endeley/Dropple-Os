import type { CameraTrackV1, CameraKeyframeV1 } from '../contracts/sceneGraph.v1';
import { selectActiveScene, selectActiveShot } from './selectors.v1';
import type { ProjectV2 } from '../contracts/project.v2';

export function resolveActiveCamera(project: ProjectV2 | null | undefined): CameraTrackV1 | null {
...
export function getCameraTransformAtTime(camera: CameraTrackV1 | null | undefined, time: number) {
...
function normalizeFrame(frame: CameraKeyframeV1) {
    return {
        x: frame.x,
        y: frame.y,
        zoom: frame.zoom,
